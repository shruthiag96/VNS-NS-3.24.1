...
#ifndef VNS_WIFI_PHY_H
#define VNS_WIFI_PHY_H
...
class VNSWifiPhy : public WifiPhy, public QTreeItem {
...
public:
   ...
   *
   * VNSWifiPhy can switch among different channels. Basically, VNSWifiPhy
  ...
  void StartReceive(Time rxTime, Ptr<Packet> packet, double rxPowerDbm, WifiTxVector txVector, enum WifiPreamble preamble);
  Vector getPoint();
  inline bool isDisposed(){ return disposed; };

private:
  VNSWifiPhy (const VNSWifiPhy &o);
